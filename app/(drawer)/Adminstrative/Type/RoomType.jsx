...
export default function RoomType() {
  ...
  const handleSubmit = () => {
    if (roomType.trim()) {
      setRoomTypes([...roomTypes, { id: roomTypes.length + 1, name: roomType }]);
      setRoomType('');
    }
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Room <Text style={{ color: '#5aaf57' }}>Type</Text></Text>
        </View>
        {/* Card 1: Input Field */}
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Add Room Type</Text>
