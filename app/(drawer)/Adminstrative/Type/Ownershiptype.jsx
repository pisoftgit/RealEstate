...
export default function Ownershiptype() {
  ...
  const [ownershipTypes, setOwnershipTypes] = useState(initialOwnershipTypes);

  const handleSubmit = () => {
    if (ownershipType.trim()) {
      setOwnershipTypes([...ownershipTypes, { id: ownershipTypes.length + 1, name: ownershipType }]);
      setOwnershipType('');
    }
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Ownership <Text style={{ color: '#5aaf57' }}>Type</Text></Text>
        </View>
        {/* Card 1: Input Field */}
