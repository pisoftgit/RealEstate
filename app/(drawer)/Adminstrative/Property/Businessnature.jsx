...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: wp('4.5%'), fontFamily: 'PlusR', color: '#333', marginBottom: hp('1.5%') },
  ...
  loadingContainer: { alignItems: 'center', padding: wp('5%') },
  loadingText: { marginTop: hp('1%'), color: '#666', fontFamily: 'PlusR' },
  noDataContainer: { alignItems: 'center', padding: wp('5%') },
  noDataText: { color: '#666', fontFamily: 'PlusR', fontSize: wp('4%') },
});
