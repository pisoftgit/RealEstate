    ...
    const sections = [
      {
        ...
        content: (
          <View style={styles.sectionContent}>
            ...
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>Funishing Status:</Text>
              <Text style={styles.detailValue}>{selectedFlat.FurnishingStatus}</Text>
            </View>
            <View style={styles.detailRow}>
    ...
    <View style={styles.flatItem}>
      ...
      <View style={styles.flatInfoWrapper}>
        ...
        <View style={styles.flatHeaderRow}>
          <Text style={styles.flatNumber}>#{item.unit}</Text>
        ...
        <View style={styles.structureAreaRow}>
          <Text style={styles.structureText}> {item.FurnishingStatus}</Text>
