...
import { getAllPlc, API_BASE_URL } from "../services/api";
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>House/Villa Details</Text>
        <View style={{ width: 24 }} />
      </View>
              ...
              <View style={styles.fillDetailsModal}>
                ...
                <ScrollView style={styles.fillDetailsContent} showsVerticalScrollIndicator={false}>
                  ...
                  <View style={styles.formSection}>
                    ...
                    <View style={styles.formRow}>
                      <Text style={styles.formLabel}>Number of Floors</Text>
                      <TextInput
                        style={styles.formInput}
                        value={formData.numberOfFloors}
                        onChangeText={(value) => handleFormDataChange('numberOfFloors', value)}
...
export default HouseVillaDetailsPage;
