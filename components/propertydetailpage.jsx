...
const styles = StyleSheet.create({
  ...
  headerBtn: { padding: wp('1.5%') },
  headerTitle: { fontSize: wp('6.2%'), color: "#333", fontFamily: "PlusSB" },
  searchRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  pageText: { marginHorizontal: wp('2%'), fontSize: wp('3.5%'), color: "#333", fontFamily: "PlusR" },
  card: {
  ...
  emptyText: { textAlign: "center", color: "#999", marginTop: hp('2.5%'), fontFamily: 'PlusR' },
  actionButtonsRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
